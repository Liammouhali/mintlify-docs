...
description: 'Developer guide: get started with the Kakiyo API in minutes. This page is for programmatic access — if you want to use Kakiyo from the dashboard, see the Dashboard Guides instead.'
---
