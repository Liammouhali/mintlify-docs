...
description: 'Developer guide: receive real-time webhook notifications for LinkedIn outreach events. This page covers payload format, signature verification, and code examples.'
---
