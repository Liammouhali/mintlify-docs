---
title: 'API Reference'
description: 'Developer reference: complete REST API documentation for the Kakiyo API. This section is for programmatic access — endpoints, authentication, error handling, and pagination.'
---
