...
Each result's `prospect` object includes current company data when available: `currentCompanyName`, `currentJobTitle`, `currentCompanyWebsite`, and `currentCompanyLinkedInUrl`.
  ...
  "prospects": [
    {
      ...
      "currentCompanyName": "TechCorp",
      "currentJobTitle": "VP of Sales",
      "currentCompanyWebsite": "https://www.techcorp.com",
      "currentCompanyLinkedInUrl": "https://www.linkedin.com/company/techcorp",
      "location": {
        "city": "San Francisco",
