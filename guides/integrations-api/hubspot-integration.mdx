...
description: "Connect HubSpot to Kakiyo from the dashboard. Sync prospects as contacts, log timeline events, associate companies, and auto-create deals when prospects qualify."
---

<Info>
  **This guide is for dashboard users.** All steps below are performed inside the [Kakiyo dashboard](https://app.kakiyo.com). No code or API calls required.
</Info>
...
- [HubSpot Integration Tutorial (with screenshots)](/integrations/hubspot)
